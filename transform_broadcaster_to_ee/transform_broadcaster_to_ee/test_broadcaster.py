...
class TestBroadcasterNode(Node):
    def __init__(self, t_path):
        ...
        #T_centre = np.dot(np.dot(np.dot(self.T_world2slider, forward_kinematics(self.joint_positions_centre, self.dh_params)), self.T_ee2base), transform_matrix_ee2rgb)
        #T_left = np.dot(np.dot(np.dot(self.T_world2slider, forward_kinematics(self.joint_positions_left, self.dh_params)), self.T_ee2base), transform_matrix_ee2rgb)
        #T_right = np.dot(np.dot(np.dot(self.T_world2slider, forward_kinematics(self.joint_positions_right, self.dh_params)), self.T_ee2base), transform_matrix_ee2rgb)
        #T_back = np.dot(np.dot(np.dot(self.T_world2slider, forward_kinematics(self.joint_positions_back, self.dh_params)), self.T_ee2base), transform_matrix_ee2rgb)
