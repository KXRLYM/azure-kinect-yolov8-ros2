...
class StaticTransformBroadcasterNode(Node):
    def __init__(self, t_path):
        ...
        transform_stamped2.header.frame_id = 'slider_link'
...
def main():
    ...
    t_path = '/home/nam017/ws_calibration/src/HandEyeCalibration-using-OpenCV/FinalTransforms/T_gripper2cam_Method_0.npz'
